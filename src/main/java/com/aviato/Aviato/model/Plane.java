...
public class Plane {
    ...
    //Adicionar Voo quando o model tiver implementado


    public Plane() {
    }

    public Plane(Long plane_id, String model, Double version, Integer capacity, String description, String madeIn, Company belongTo) {
        Plane_id = plane_id;
        this.model = model;
